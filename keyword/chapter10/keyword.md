...
웹브라우저는 기본적으로 “내가 받은 사이트에서 내려준 자바스크립트는, 그 도메인, 프로토콜, 포트가 딱 같은 곳에만 AJAX 요청을 보내고, 응답도 읽을 수 있게 해준다.  
다른 곳으로 요청을 보내면 보내는 것은 허용, 읽기는 차단한다. -> 이유: 세션 쿠키까지 자동으로 따라가 버리면 정보가 새어나갈 수 있기 때문.

### CORS(Cross-Origin Resource Sharing)
**CORS(Cross-Origin Resource Sharing)는 “예외 허가증”**  
